...
export class Rutas {
    ...
    #rutaC_Confesion(): void {
        ...
        if (opcion === 0) {
            this.#protagonista.hablar("¿Estás atrapado?")
        }
        else if (opcion === 1) {
            this.#protagonista.hablar("¿Quieres salir?")
        }
        else {
            this.#protagonista.hablar("¿Quieres compañía?")
